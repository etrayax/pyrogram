...
class OnReadHistoryInbox:
    def on_read_history_inbox(
        ...
        :obj:`~pyrogram.handlers.ReadHistoryInbox`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogram.Client):
                self.add_handler(pyrogram.handlers.ReadHistoryInboxHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogram.handlers.ReadHistoryInboxHandler(func, self),
